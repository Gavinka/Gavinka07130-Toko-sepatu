...
public class Gavinka07130_GUI {
    ...
    public Gavinka07130_GUI(){ //komponen
        TampilanAwal.setSize(700, 830); //ukuran 
        TampilanAwal.setLayout(null);
        TampilanAwal.getContentPane().setBackground(Color.GREEN); //warna background
        
        top = new JLabel("====  Vins  Shoes  Store ====");
        ...
        check.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent ae){ //method
                if(ceklogin==true){
                    try{ 
                        Gavinka07130_Allobjctrl.admin.datapegawai(); // login untuk pegawai
                        Gavinka07130_Allobjctrl.admin.login(textidlogin.getText(), textnamalogin.getText());
                        String nama = Gavinka07130_Allobjctrl.admin.PegawaiEntity().getnama(); //memasukkan id,nama, jika benar 
                        JOptionPane.showMessageDialog(null, "Selamat datang "+nama,"information", JOptionPane.INFORMATION_MESSAGE);
                        Gavinka07130_PegawaiGUI pegawai = new Gavinka07130_PegawaiGUI();
                    ...
                    try{ //login untuk pembeli
                       Gavinka07130_Allobjctrl.pembeli.login(textidlogin.getText(),textnamalogin.getText());
                       String nama = Gavinka07130_Allobjctrl.pembeli.getData().getnama(); //memasukkan id,nama, jika benar 
                       JOptionPane.showMessageDialog(null, "Selamat datang "+nama,"information", JOptionPane.INFORMATION_MESSAGE);
                       Gavinka07130_PembeliGUI  pel = new Gavinka07130_PembeliGUI();
                       TampilanAwal.dispose();
        ...
        reg.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent ae){
                try{
                    ...
                    Gavinka07130_Allobjctrl.pembeli.insert(id, nama, alamat, nopelanggan, notelp); //jika sukses
