...
public class main {
    ...
    void viewMenu(){
        ...
        do{
           System.out.print("Selamat Datang Di Vins Shoes !!" +
                            "\n 1. Login" +
                            "\n 2. Daftar Pelanggan" +
                            "\n 3. Hapus Pelanggan"+
                            "\n 4. Lihat Pelanggan"+
        ...
        for (int i = 0; i < SepatuEntity.tas.length; i++) {
            System.out.println((i) + " " + SepatuEntity.tas[i]);
        }
        ...
        for (DaftarPembeliEntity pembeli : pembeliModel.cekDaftarPembeliModel()) {
                ...
                System.out.println("Tas = "+SepatuEntity.tas[pembeliModel.showDaftarPembeli(i).getIndexTas()]);
        ...
        System.out.println("Tas = "+SepatuEntity.tas[pembeliModel.showDaftarPembeli(cekpembeli).getIndexTas()]);
        System.out.println("isVerified = ");
        ...
        pegawaiModel.updateIsVerified(index, pembeliModel.showDaftarPembeli(index).getIndexTas(),pembeliModel.showDaftarPembeli(index).getPembeli());
    }
